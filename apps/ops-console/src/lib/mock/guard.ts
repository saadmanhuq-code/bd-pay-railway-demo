...
// during local development. The operator login accepts any email plus a
// server-verified mock TOTP with no password, so these routes MUST NOT be
// reachable in a production build. This guard is called as the first
// statement of every mock route handler.
//
