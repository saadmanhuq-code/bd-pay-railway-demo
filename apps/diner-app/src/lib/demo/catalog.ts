...
const DEMO_OFFERS: DemoOffer[] = [
  {
    ...
    percent_bps: 2500,
    windows: [{ days: ["SUN", "MON", "TUE", "WED", "THU"], start_local: "14:30", end_local: "18:00" }],
  ...
  },
  {
    ...
    percent_bps: 2000,
    windows: [{ days: ["FRI", "SAT"], start_local: "15:00", end_local: "18:30" }],
    min_spend_minor: 50000,
  ...
  },
  {
    ...
    percent_bps: 3000,
    windows: [{ days: ["FRI", "SAT"], start_local: "00:00", end_local: "23:59" }],
